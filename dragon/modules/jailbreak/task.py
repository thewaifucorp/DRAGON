...
@task
def jailbreak(adapter: str = "null") -> Task:
    """Benchmark jailbreak resistance on the dual axis (under-block × over-block).

    Covers identity-override (DAN), fictional wrappers, authority claims,
    hypothetical distancing, emotional manipulation, many-shot priming,
    obfuscation, and nested roleplay.
